...
" method="post">                <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="right"><label for="password2">密码确认</label><span class="required">*</span></label></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td align="right"><label for="user_email">邮箱</label>
                                        <span class="required">*</span></label>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right"><label for="user_qq">qq号码</label>
                                        <td>
                                    ...
                                    <tr>
                                        <td align="right"><label for="user_tel">手机</label>
