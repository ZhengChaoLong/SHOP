<?php /* Smarty version Smarty-3.1.6, created on 2016-05-04 20:07:36
...
'>
                                ...
                                <tr>
                                    <td>我的QQ</td>
                                    <td>
                                        <input type='text' name='user_qq' value='<?php echo $_smarty_tpl->tpl_vars['info']->value['user_qq'];?>
'></td>
                                ...
                                <tr>
                                    <td>我的手机</td>
                                    <td>
                                        <input type='text' name='user_tel' value='<?php echo $_smarty_tpl->tpl_vars['info']->value['user_tel'];?>
'></td>
                                ...
                                <tr>
                                    <td>我的简介</td>
                                    <td>
                                        <textarea name='user_introduce'><?php echo $_smarty_tpl->tpl_vars['info']->value['user_introduce'];?>
</textarea>
                                    </td>
                                </tr>
                            </tbody>
